#!/usr/bin/env python3
"""
pdf2docx_convert.py - PDF to DOCX conversion helper for Aerialist.
...
def postprocess_docx(pdf_path, docx_path, page_indices=None):
    ...
    temp_dir = tempfile.mkdtemp(prefix="aerialist_postprocess_")
    try:
        # Extract DOCX
...
def convert_scanned_pdf(input_path, output_path, start, end, pages_param):
    ...
    temp_dir = tempfile.mkdtemp(prefix="aerialist_scan_")
    pages_done = 0
