...
enum WordExportService {
    ...
    enum WordExportError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .pythonNotFound:
                return "Python 3 with pdf2docx not found. The bundled Python may be missing — try reinstalling Spindrift."
            case .helperScriptNotFound:
    ...
    static func export(
        ...
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("spindrift_\(UUID().uuidString)")
    ...
    private static func findHelperScript() throws -> String {
        ...
        let devPaths = [
            ...
            "Spindrift/Spindrift/Resources/pdf2docx_convert.py",
            "../Spindrift/Spindrift/Resources/pdf2docx_convert.py",
        ]
